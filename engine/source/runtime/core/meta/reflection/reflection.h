...
#define TypeMetaDef(class_name, ptr) \
    MGame::Reflection::ReflectionInstance(MGame::Reflection::TypeMeta::newMetaFromName(#class_name), \
                                            (class_name*)ptr)

#define TypeMetaDefPtr(class_name, ptr) \
    new MGame::Reflection::ReflectionInstance(MGame::Reflection::TypeMeta::newMetaFromName(#class_name), \
                                                (class_name*)ptr)
